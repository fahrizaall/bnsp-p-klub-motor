  ...
  <div class="w-full lg:w-2/3 m-auto">
    ...
    <div class="w-1/2 m-auto">
      <form action="/auth/signup" class="flex flex-col" method="POST">
        ...
        <input type="email" name="email" id="email" class="mb-4 border-2 border-slate-700 rounded-md focus:outline-none focus:ring-0 py-1 px-2" placeholder="email@email.com">
        
        <label for="password" class="font-semibold text-sm mb-1">Password</label>
        <input type="password" name="password" id="password" class="border-2 border-slate-700 rounded-md focus:outline-none focus:ring-0 py-1 px-2" placeholder="password">
      
        <button type="submit" class="bg-slate-900 text-white py-2 rounded-md mt-8">Signup</button>
      </form>
    </div>
  </div>
</div>
